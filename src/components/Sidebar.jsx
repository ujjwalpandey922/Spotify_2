...
const NavLinkss =({handleClick})=>(
  <div className="mt-4">
    {links.map((e)=> (
      <NavLink to={e.to} key={e.name} className={`flex flex-row justify-start items-center my-8 text-2xl font-large text-gray-400 hover:text-red-200 `}  onClick={()=>handleClick && handleClick()}>
...
const Sidebar = () => {
  ...
  return(
    <>
    <div className="hidden flex-col w-[200px] py-10 px-4 bg-red-800 md:flex">
